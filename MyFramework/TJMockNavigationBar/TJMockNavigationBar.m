...
- (void)initialization {
    self.backgroundColor = [UIColor colorWithRed:71/255.0 green:179/255.0 blue:90/255.0 alpha:1];
...
- (void)setupViews {
    ...
    [_leftButton setBackgroundImage:[UIImage imageNamed:@"iconNavBackLeft"] forState:UIControlStateNormal];
