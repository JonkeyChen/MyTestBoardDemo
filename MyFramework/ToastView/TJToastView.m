...
+ (void)showWithText:(NSString *)text_{
    [TJToastView showWithText:text_ duration:DEFAULT_DISPLAY_DURATION];
}

+ (void)showWithText:(NSString *)text_
            duration:(CGFloat)duration_{
    TJToastView *toast = [[TJToastView alloc] initWithText:text_];
...
+ (void)showWithText:(NSString *)text_
    ...
    [TJToastView showWithText:text_  topOffset:topOffset_ duration:DEFAULT_DISPLAY_DURATION];
}
...
+ (void)showWithText:(NSString *)text_
    ...
    [TJToastView showWithText:text_  bottomOffset:bottomOffset_ duration:DEFAULT_DISPLAY_DURATION];
}
